...
#include "handlers/shopping_item_handler.h"
#include "handlers/shopping_cart_handler.h"
...
public:
        ...
        const HTTPServerRequest& request)
    {
        ...
        {
            return new ShoppingItemHandler(_format);
        }
        else if (startsWith(request.getURI(), "/shopping-cart"))
        {
            return new ShoppingCartHandler(_format);
        }
        return 0;
    }
